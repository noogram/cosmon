...
#                           (default: cosmon-bench — a profile that belongs
#                           to the benches and to nothing else)
#   COSMON_DOCKER_CONTEXT   explicit docker context override. Corrected on
#                           2026-07-27: this used to default to
#                           `desktop-linux` on the belief that Docker
#                           Desktop was the tester's engine and that colima
#                           was "NOT faithful". The tester corrected his own
#                           description that day on issue #20 — his bed is
#                           Colima (Lima-based), Ubuntu 24.04.4 LTS, aarch64
#                           — and the measured posture of both engines is in
#                           docs/benches/engine-fidelity-2026-07-27.md.
#                           Docker Desktop reproduces NEITHER of his two
#                           standing findings (its bind-mount honours chown,
#                           and `unshare` is not blocked there); colima
#                           reproduces both. An unreachable engine is
#                           INCONCLUSIVE, never a fallback to another one.
