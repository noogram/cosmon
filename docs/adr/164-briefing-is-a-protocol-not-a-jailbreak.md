...
[§8z — A protocol explains itself, and every state it can reach has a
door](../architectural-invariants.md#8z-a-protocol-explains-itself-and-every-state-it-can-reach-has-a-door).
